package com.example.administrator.myzzhihuday.view;
...
public class Banner extends FrameLayout implements View.OnClickListener {
    ...
    public void setTopStoriesEntities(List<Latest.TopStoriesEntity> toEntities) {
        this.topStoriesEntities = toEntities;
        reset();
    }
